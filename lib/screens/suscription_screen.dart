...
class SuscriptionScreen extends StatelessWidget {
  const SuscriptionScreen({super.key, required this.userModel});
  final UserModel userModel;
  @override
  Widget build(BuildContext context) {
    return SuscriptionScreenWidget(userModel: userModel,);
    
  }
}

class SuscriptionScreenWidget extends StatefulWidget {
  const SuscriptionScreenWidget({super.key, required this.userModel});
  final UserModel userModel;

  @override
  State<SuscriptionScreenWidget> createState() => _SuscriptionScreenState();
}

class _SuscriptionScreenState extends State<SuscriptionScreenWidget> {
  ...
  void _openCamera(BuildContext context) async {
    ...
    if(imageFile!=null){
      Navigator.of(context).push(MaterialPageRoute(builder: (context) => NewPublicationScreen(userModel: widget.userModel, imageNewPublication: imageFile!),));
    }
  }
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Container(
        child: ListView(
          children: [
            UI('assets/creator.jpg', 'Juan Pablo Jaramillo Nieto', 'Encontre este perrito abandonado','Caniche', '28-11-2022', 'assets/Ejemplo2.jpg', 'Hacienda de Guanave ll 104A, Villas de la Arbolada, Celaya', "20.5576241", "-100.8517272",context),
           ],
        )
      ),
